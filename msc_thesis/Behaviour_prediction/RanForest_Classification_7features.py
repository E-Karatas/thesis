...
print("incorrect predictions on training set with 7 features:", non_diagonal_sum)
...
print("incorrect predictions on validation set with 7 features:", bio_non_diagonal_sum)
